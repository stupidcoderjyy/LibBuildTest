...
# 执行 lscpu | grep -i avx512 命令
execute_process(
    COMMAND sh -c "lscpu | grep -i avx512"  # 用sh -c包裹管道命令，避免cmake解析错误
...
if(LSCPU_AVX2_OUTPUT)
    message(STATUS "AVX512 +")
    set(AVX512_NOT_SUPPORTED 0)
else()
    message(STATUS "AVX512 -")
    set(AVX512_NOT_SUPPORTED 1)
endif()